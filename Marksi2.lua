...
./tg -s ./Marksi2.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("Run", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S Marksi2 -X kill
screen -S Marksi2 ./Marksi2.sh
done
]]) 
file:close() 
...
NameBot = (DevAbs:get(WaTaN2..'Abs:NameBot') or 'ماركسي')
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
...
if File_Name ~= "Marksi2.lua" then 
send(chat,msg.id_," ✯︙هذا الملف ليس تابع لسورس ماركسي")
return false 
end      
local File = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/getfile?file_id='..ID_FILE) ) 
os.execute('rm -rf Marksi2.lua')
...
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..Abs},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..Abs}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..Abs},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..Abs}},{{text = '⌁ WaTaN2 TeAM.',url="t.me/WaTaNTeaM"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..Abs},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..Abs}}}
elseif Admin(data) then
...
keyboard = {}
keyboard.inline_keyboard = {{{text="‹ غادر ›",callback_data="/LeaveBot:"..data.sender_user_id_},{text="‹ تفعيل ›",callback_data="/On:"..data.sender_user_id_}},{{text="‹ WaTaN TeaM ›",url="t.me/WaTaNTeaM"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '✯ WaTaN TeaM .',url="t.me/WaTaNTeaM"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
...
os.execute('rm -rf Marksi2.lua') 
os.execute('wget https://raw.githubusercontent.com/FaRaAP16/Marksi2/main/Marksi2.lua') 
dofile('Marksi2.lua') 
...
if text and text:match('^'..(DevAbs:get(WaTaN2..'Abs:NameBot') or "ماركسي")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevAbs:get(WaTaN2..'Abs:NameBot') or "ماركسي")..' ','')
end
...
{{text="✯ السورس .",url="https://t.me/Iraqiatheists1"},{text="✯ لتنصيب بوت .",url="https://t.me/Iraqiatheists1/6109"}},{{text="✯ اضفني في مجموعتك .",url="t.me/"..dpbot.username_.."?startgroup=botstart"}}
}
...
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './Marksi2.lua', '✯︙نسخة ملف سورس ماركسي',dl_cb, nil)
end end
...
local BotName = (DevAbs:get(WaTaN2.."Abs:NameBot") or 'ماركسي')
...
if text and text == (DevAbs:get(WaTaN2..'Abs:NameBot') or 'ماركسي') then 
NameBot = (DevAbs:get(WaTaN2..'Abs:NameBot') or 'ماركسي')
...
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..Abs},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..Abs}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..Abs},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..Abs}},{{text = '⌁ WaTaN2 TeAM.',url="t.me/WaTaNTeaM"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..Abs},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..Abs}}}
elseif Admin(data) then
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Iraqiatheists1&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
...
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/WaTaNTeaM' end
...
Text = "✯︙تم تفعيل المجموعه "..dp.title_
local inline = {{{text="‹ ترتيب الاوامر ›",callback_data="/SetCmdGp:"..msg.sender_user_id_},{text="‹ رفع الادمنيه ›",callback_data="/UploadAdmin:"..msg.sender_user_id_}},{{text="‹ غادر ›",callback_data="/LeaveBot:"..msg.sender_user_id_},{text="‹ تعطيل ›",callback_data="/Stop:"..msg.sender_user_id_}},{{text="‹ WaTaN TeaM ›",url="t.me/WaTaNTeaM"}}}
...
Text = "✯︙تم تعطيل المجموعه "..dp.title_
local inline = {{{text="‹ غادر ›",callback_data="/LeaveBot:"..msg.sender_user_id_},{text="‹ تفعيل ›",callback_data="/On:"..msg.sender_user_id_}},{{text="‹ WaTaN TeaM ›",url="t.me/WaTaNTeaM"}}}
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
DevAbs:srem(WaTaN2.."Abs:Groups",msg.chat_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
io.popen("cd Files && wget https://raw.githubusercontent.com/WaTaNtEaM/Marksi2Files/main/WaTaN2Files/AddedMe.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/WaTaNtEaM/Marksi2Files/main/WaTaN2Files/AutoFile.lua")  
io.popen("cd Files && wget https://raw.githubusercontent.com/WaTaNtEaM/Marksi2Files/main/WaTaN2Files/ChangeName.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/WaTaNtEaM/Marksi2Files/main/WaTaN2Files/ChangePhoto.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/WaTaNtEaM/Marksi2Files/main/WaTaN2Files/ChangeUser.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/WaTaNtEaM/Marksi2Files/main/WaTaN2Files/MuteNames.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/WaTaNtEaM/Marksi2Files/main/WaTaN2Files/ProNames.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/WaTaNtEaM/Marksi2Files/main/WaTaN2Files/ReplyBot.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/WaTaNtEaM/Marksi2Files/main/WaTaN2Files/TagAdmins.lua") 
io.popen("cd Files && wget https://raw.githubusercontent.com/WaTaNtEaM/Marksi2Files/main/WaTaN2Files/TagAll.lua") 
...
DevAbs:set(WaTaN2..'Abs:NameBot',(DevAbs:get(WaTaN2..'Name:Bot') or 'ماركسي'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
...
Text = [[
✯︙[قناة السورس](https://t.me/Iraqiatheists1)
]]
keyboard = {} 
keyboard.inline_keyboard = {
